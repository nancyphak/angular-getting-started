...
1. include `bootstrap-progressbar.js`
    ...
    ```html
    <script type="text/javascript" src="bootstrap-progressbar.js"src/resources/themes/gentelella/script>
    ```
...
3. set the `aria` attribute and __remove__ the `width` style attribute (alternatively you can set it to 0)
    ...
    1. `data-transitiongoal`
        ...
        ```html
        <div class="progress">
            <div class="progress-bar" data-transitiongoal="75"src/resources/themes/gentelella/div>
        </div>
        ```
    ...
    2. `aria-valuemin` (default: 0) and `aria-valuemax` (default: 100)
        ...
        ```html
        <div class="progress">
            <div class="progress-bar" data-transitiongoal="75" aria-valuemin="-1337" aria-valuemax="9000"src/resources/themes/gentelella/div>
        </div>
        ```
...
* Do I need the additional style file?
    ...
    * for any vertical bars or the horizontal bar with centered text or right aligned bar: __YES__
        ...
        <script src="less.js" type="text/javascript"src/resources/themes/gentelella/script>
        ```
